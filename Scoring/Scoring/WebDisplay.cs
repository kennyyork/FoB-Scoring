...
namespace Scoring
{
    public partial class WebDisplay : Form
    {
        ...
        private const string TABLE_TITLE = @"<tr><th class=""table_title"" colspan=""0"">{0}</th></tr>";
        ...
        private const string TEAM_SCORE_SECTION_HEADER = @"<tr><th colspan=""0"" class=""score_section"">{0}</th></tr>";
